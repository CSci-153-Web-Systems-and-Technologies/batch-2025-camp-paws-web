    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">You reported in total</p>
              <p className="text-2xl font-bold text-gray-900">100 reports</p>
              <p className="text-xs text-gray-500">by you since you joined</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">You reported this week</p>
              <p className="text-2xl font-bold text-gray-900">26 reports</p>
              <p className="text-xs text-gray-500">in the past 7 days</p>
            </div>
            <div className="text-gray-400">ℹ️</div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500">by all users this year</p>
            </div>
            <div className="text-gray-400">ℹ️</div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500">found safe homes</p>
            </div>
            <div className="text-gray-400">ℹ️</div>
          </div>
        </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border">
        <div className="mb-4">
          ...
          <p className="text-sm text-gray-600">330 reports this month</p>
        </div>
